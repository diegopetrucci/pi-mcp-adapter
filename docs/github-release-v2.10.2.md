Publishes the tlh-maintained fork as the scoped npm package `@diegopetrucci/pi-mcp-adapter@2.10.2` and prepares the tlh release tag `tlh-v2.10.2`.
...
- Follow `docs/publish-checklist-v2.10.2.md` for reviewer signoff, tagging, human-only npm publish, and post-publish validation after npm propagation
